...
/**
 * The HTTP adapter of the signing side: which status a valid or an invalid
 * signature answers with is a property of the API, so it is decided here, while
 * whether the signature matches is asked of the `SigningService` port.
 */
